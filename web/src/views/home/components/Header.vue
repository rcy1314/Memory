            ...
            <ul>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav-item-child">
                        <ul>
                            <li v-for="category in categories" :key="category.id || category.alias" class="category-level-0 category-parent">
                                <router-link :to="'/category/' + category.alias">{{ category.name }}</router-link>
                                <ul>
                                    <li v-for="child in category.children" :key="child.id || child.alias"
